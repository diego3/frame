...
// HandleClick invokes OnClick, if set. Implements ui.Element.
...
// Draw renders the button on screen, using HoverColor when hovered is true. Implements ui.Element.
func (b *Button) Draw(screen *ebiten.Image, face font.Face, hovered bool) {
	fill := b.FillColor
	if fill == nil {
