...
import (
	...
	"goengine/frameengine/view/input"
...
func (g *Game) Init() error {
	...
	g.scriptEngine.RegisterEngineAPI(
		...
		// through it (see ScriptEngine()'s doc comment) and WorldScene registers its own engine
		// with a real getEntityPosition wired to its own world (see view/scene/world_scene.go).
...
// engine instance has no scene/world of its own -- see WorldScene, which registers its own engine
